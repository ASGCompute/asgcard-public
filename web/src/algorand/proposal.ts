...
<div class="max-w-[48rem] mx-auto px-8 py-6 flex flex-col min-h-screen">
  ...
  <div class="mb-6 flex justify-between items-start gap-4">
    <div>
      ...
      <h1 class="text-3xl font-bold tracking-tight text-gray-900 mb-2 sm:text-4xl">
        Programmable Virtual Cards for AI Agents on Algorand
      </h1>
      <p class="text-[14px] text-gray-600 max-w-2xl leading-snug mt-1">
        Enable autonomous AI agents to spend safely and programmatically. ASG Card provides instant virtual cards for agent-driven payments — funded via the x402 protocol, settled in USDC on Algorand, and secured by PayAI.
      </p>
    </div>
    <div class="flex items-center pt-2 shrink-0">
      <img src="/algorand-logo.svg" class="h-8 object-contain" style="filter: brightness(0) opacity(0.8);" alt="Algorand" />
    </div>
  </div>
    ...
    <div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex gap-3">
          ...
          <div class="text-[13px] text-gray-700 leading-snug"><span class="font-semibold text-gray-900">Settlement:</span> USDC settles on Algorand and payment is confirmed.</div>
        </div>
        <div class="flex gap-3">
  ...
  <div class="mb-6 border-t border-gray-100 pt-5">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      <div class="space-y-1">
        <div class="text-[14px] font-bold text-gray-900 border-b border-gray-200 pb-1 mb-2">Algorand</div>
        <div class="text-[12px] text-gray-800 font-medium">USDC settlement growth & brand leadership in agentic commerce.</div>
        <div class="text-[12px] text-gray-500 leading-snug mt-1">Drives real-world USDC volume and highlights Algorand’s near-instant, low-fee microtransactions for AI native use-cases.</div>
      </div>
      <div class="space-y-1">
  ...
  <div class="border-t border-gray-100 pt-5 flex-grow">
    ...
    <div class="grid md:grid-cols-2 gap-x-8 gap-y-4 items-start">
      <div class="flex gap-2 text-[13px] text-gray-700">
        ...
        <div class="leading-snug"><b>Co-Development & Sandbox:</b> Integrate ASG Card with PayAI's upcoming Algorand infrastructure. Validate the x402 USDC flow.</div>
      </div>
      <div class="flex gap-2 text-[13px] text-gray-700">
