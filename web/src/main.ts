      ...
      <section id="pricing" class="py-24 md:py-32 border-t border-white/[0.04]">
        <div class="max-w-6xl mx-auto px-6">
          <div class="text-center max-w-xl mx-auto mb-16">
            ...
            <p class="text-white/40 text-base mt-4">Usage-based pricing by default. Optional Pro for teams running multiple agents.</p>
          </div>
          ...
          <div class="max-w-5xl mx-auto mt-6">
            <div class="surface pricing-pro-card p-6 sm:p-8">
              <div class="pricing-pro-card__header">
                <div>
                  <div class="flex flex-wrap items-center gap-2 mb-3">
                    <span class="pricing-pro-badge pricing-pro-badge--beta">Pro</span>
                    <span class="pricing-pro-badge">For Multi-Agent Teams</span>
                  </div>
                  <h3 class="pricing-pro-card__title">ASG Pro for multi-agent teams</h3>
                  <p class="pricing-pro-card__sub">
                    Keep pay-as-you-go pricing. Pro lowers your ASG service fee at volume and adds team operations controls.
                  </p>
                </div>
                <div class="pricing-pro-price pricing-pro-price--panel">
                  <div class="pricing-pro-price__value">$99<span>/mo</span></div>
                  <div class="pricing-pro-price__caption">Monthly subscription</div>
                  <div class="pricing-pro-price__hint">Best for teams running recurring agent tasks</div>
                </div>
              </div>

              <div class="pricing-pro-metrics" aria-label="Pro plan value summary">
                <div class="pricing-pro-metric">
                  <div class="pricing-pro-metric__icon" aria-hidden="true">🎟️</div>
                  <div class="pricing-pro-metric__value">30 ops / mo</div>
                  <div class="pricing-pro-metric__label">ASG service-fee credits</div>
                </div>
                <div class="pricing-pro-metric">
                  <div class="pricing-pro-metric__icon" aria-hidden="true">↘</div>
                  <div class="pricing-pro-metric__value">$2 → $1</div>
                  <div class="pricing-pro-metric__label">ASG fee after credits</div>
                </div>
                <div class="pricing-pro-metric">
                  <div class="pricing-pro-metric__icon" aria-hidden="true">📈</div>
                  <div class="pricing-pro-metric__value">~70 ops</div>
                  <div class="pricing-pro-metric__label">Estimated break-even / month</div>
                </div>
              </div>

              <div class="pricing-pro-feature-list">
                <div class="pricing-pro-feature">
                  <span class="pricing-pro-feature__icon" aria-hidden="true">⚡</span>
                  Priority support & escalation
                </div>
                <div class="pricing-pro-feature">
                  <span class="pricing-pro-feature__icon" aria-hidden="true">🚀</span>
                  Higher limits & throughput
                </div>
                <div class="pricing-pro-feature">
                  <span class="pricing-pro-feature__icon" aria-hidden="true">👥</span>
                ...
                <div class="pricing-pro-feature">
                  <span class="pricing-pro-feature__icon" aria-hidden="true">🧾</span>
                  Policies, audit logs & controls
                </div>
              </div>

              <div class="pricing-pro-card__footer">
                <div class="pricing-pro-note">
                  Issuer and top-up fees still apply. Pro discounts ASG service fees only.
                </div>
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                  <a href="/docs" class="btn-primary liquid-btn text-sm px-5 py-2.5 text-center">Join Pro</a>
                </div>
              </div>
            </div>
          </div>
