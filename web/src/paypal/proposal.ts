...
<div class="max-w-[48rem] mx-auto px-8 py-6 flex flex-col min-h-screen">
  ...
  <div class="mb-6 flex justify-between items-start gap-4">
    <div>
      ...
      <h1 class="text-3xl font-bold tracking-tight text-gray-900 mb-2 sm:text-4xl">
        Programmable Virtual Cards for AI Agents via PYUSD
      </h1>
      <p class="text-[14px] text-gray-600 max-w-2xl leading-snug mt-1">
        Enable autonomous AI agents to spend safely and programmatically. ASG Card provides instant virtual cards for agent-driven payments — funded via the x402 protocol, settled in PayPal USD (PYUSD), and utilizing PayPal's robust payment ecosystem.
      </p>
    </div>
    <div class="flex items-center pt-2 shrink-0">
      <img src="/paypal-logo.svg" class="h-8 object-contain" alt="PayPal" />
    </div>
  </div>
    ...
    <div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex gap-3">
          ...
          <div class="text-[13px] text-gray-700 leading-snug"><span class="font-semibold text-gray-900">x402 challenge &amp; payment:</span> Authenticates payment intent.</div>
        </div>
        <div class="flex gap-3">
          <div class="font-bold text-gray-400 text-[13px]">3.</div>
          <div class="text-[13px] text-gray-700 leading-snug"><span class="font-semibold text-gray-900">Settlement:</span> PYUSD settles on-chain and payment is confirmed.</div>
        </div>
        <div class="flex gap-3">
  ...
  <div class="grid md:grid-cols-2 gap-8 mb-6 border-t border-gray-100 pt-5">
    ...
    <div>
      ...
      <ul class="space-y-2 text-[13px] text-gray-700 list-inside marker:text-gray-400" style="list-style-type: square;">
        <li class="pl-1" style="text-indent: -1rem; margin-left: 1rem;"><span class="font-semibold text-gray-900">Autonomous ops:</span> agents buy APIs/cloud in real time with policy-bound cards via PYUSD.</li>
        ...
        <li class="pl-1" style="text-indent: -1rem; margin-left: 1rem;"><span class="font-semibold text-gray-900">Cross-border teams:</span> centralized PYUSD treasury, distributed virtual cards.</li>
      </ul>
      <p class="text-[11px] text-gray-500 mt-3 italic">Applicable to agentic frameworks requiring trusted stablecoin settlement.</p>
    </div>
    ...
    <div>
      ...
      <ul class="space-y-2 text-[13px] text-gray-700 list-inside marker:text-gray-400" style="list-style-type: square;">
        <li class="pl-1" style="text-indent: -1rem; margin-left: 1rem;">Teams shipping agentic products with enterprise-grade compliance needs.</li>
        ...
        <li class="pl-1" style="text-indent: -1rem; margin-left: 1rem;">Treasury teams preferring PYUSD settlement rails for safety and liquidity.</li>
  ...
  <div class="mb-6 border-t border-gray-100 pt-5">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      <div class="space-y-1">
        <div class="text-[14px] font-bold text-gray-900 border-b border-gray-200 pb-1 mb-2">PayPal / PYUSD</div>
        <div class="text-[12px] text-gray-800 font-medium">PYUSD utility expansion in agentic commerce.</div>
      ...
      <div class="space-y-1">
        ...
        <div class="text-[12px] text-gray-800 font-medium">Enterprise trust via regulated stablecoins.</div>
        <div class="text-[12px] text-gray-500 leading-snug mt-1">Faster pilot-to-scale conversion with institutional clients by leveraging PYUSD's regulatory compliance.</div>
      </div>
    </div>
  </div>
  ...
  <div class="border-t border-gray-100 pt-5 flex-grow">
    ...
    <div class="grid md:grid-cols-2 gap-x-8 gap-y-4 items-start">
      ...
      <div class="flex gap-2 text-[13px] text-gray-700">
        ...
        <div class="leading-snug"><b>Closed Beta Launch:</b> Roll out to a select cohort of enterprise agent developers. Monitor PYUSD conversion and off-ramp logic.</div>
      </div>
      <div class="flex gap-2 text-[13px] text-gray-700">
        <div class="font-bold text-gray-400">3.</div>
        <div class="leading-snug"><b>Public Mainnet Release:</b> Open the full solution to the developer ecosystem, supported by joint marketing with PayPal.</div>
      </div>
      <div class="flex gap-2 text-[13px] text-gray-700">
