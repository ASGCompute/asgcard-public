...
<div class="max-w-[48rem] mx-auto px-8 py-6 flex flex-col min-h-screen">
    ...
    <div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex gap-3">
          ...
          <div class="text-[13px] text-gray-700 leading-snug"><span class="font-semibold text-gray-900">Settlement:</span> USDC settles on Stellar and payment is confirmed.</div>
        </div>
        <div class="flex gap-3">
  ...
  <div class="mb-6 border-t border-gray-100 pt-5">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      <div class="space-y-1">
        <div class="text-[14px] font-bold text-gray-900 border-b border-gray-200 pb-1 mb-2">Stellar</div>
  ...
  <div class="mt-8 pt-4 border-t border-gray-100 flex justify-between items-center text-[10px] text-gray-400 uppercase tracking-wider">
    ...
    <div>Updated: February 20, 2026</div>
  </div>
</div>
